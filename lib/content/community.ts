...
export const communityPosts: CommunityPost[] = [
  {
    ...
    body: [
      ...
      '병원에서는 짧게 자주 해보라고 했는데, 보호자 입장에서는 아이가 힘들어하는 것 같아 망설여져요.',
  ...
  },
  {
    ...
    preview: '아주 작은 변화지만 기록으로 남기니 마음이 놓여요.',
    body: [
      '지난주보다 오른쪽으로 따라보는 시간이 조금 길어졌어요.',
      '아직 매일 컨디션 차이는 있지만 기록이 쌓이니까 조급함이 줄어드는 느낌이에요.',
    ],
    likeCount: 31,
    commentCount: 9,
    createdAt: '2026-05-10T20:15:00+09:00',
    recentComment: '작은 변화도 정말 큰 힘이 되죠. 응원해요.',
    comments: [
      {
        id: 'comment-3',
        author: '도담맘',
  ...
  },
  {
    ...
    body: [
      ...
      '촬영 기록은 아이가 비교적 편안한 시간에, 보호자 두 명이 함께 진행하면 더 안정적이에요.',
    ],
    likeCount: 42,
    commentCount: 4,
