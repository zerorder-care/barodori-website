...
export const newsroomPosts: NewsroomPost[] = [
  {
    ...
    excerpt: '스토어 오픈 전 바로도리를 먼저 사용해보고 홈케어 운동 기록 경험을 나눠주실 보호자를 모집합니다.',
  ...
  },
  {
    ...
    excerpt: '집에서 한 운동과 아이 반응을 기록하고 달력·리포트로 확인할 수 있는 보호자 중심 앱을 준비 중입니다.',
  ...
  },
  {
    ...
    excerpt: '홈케어 노트가 진단이나 치료 판단을 대신하지 않도록 참고 정보 검토 기준을 마련하고 있습니다.',
